...
| FUN-003 | Customers can create accounts.                                                                                                                                      | Project owner                                            | `CONFIRMED` | P0       | Registration/account screens                                     | Confirm whether accounts are optional or mandatory for purchase                       |
